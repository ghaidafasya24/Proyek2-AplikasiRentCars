...
@section('content')
    ...
    <header class="masthead">
        <div class="container">
            ...
            <!-- Button Pengembalian Mobil -->
            {{-- <button type="button" class="" onclick="return window.location.href = '{{ route('formPengembalian') }}'">
                PENGEMBALIAN MOBIL
            </button> --}}
    ...
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Selamat datang di Rent-Cars, tempat di mana kenyamanan dan
                    kemudahan bertemu. Temukan pengalaman menyewa mobil yang tak tertandingi dengan website kami yang
                    inovatif dan user-friendly.</h3>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Sewa mobil hanya dalam beberapa langkah mudah! Pilih mobil yang Anda inginkan,
                        atur tanggal dan lokasi pengambilan, dan selesaikan pembayaran dengan cepat.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Keamanan Anda adalah prioritas utama kami. Dengan enkripsi data tingkat tinggi,
                        kami memastikan setiap transaksi dan informasi pribadi terjamin keamanannya. Nikmati pengalaman
                        menyewa mobil tanpa khawatir di Rent-Cars.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Butuh bantuan atau punya pertanyaan? Tim dukungan pelanggan kami siap membantu.
                        Hubungi kami melalui email di rentcars@gmail.com.</p>
                </div>
            </div>
        </div>
    </section>
