...
@section('content')
    <div class="layouts">
        ...
        @foreach ($mobils as $mobil)
            <div class="card_card">
                <div class="card-img">
                    <img src="{{ asset('assets/img/mobil/'.$mobil->gambar) }}" width="100" alt="">
                </div>
                <div class="card-title">{{ $mobil->merek_mobil }}</div>
                <div class="card-subtitle">Mobil dengan keluaran tahun {{ $mobil->tahun }} dengan warna {{ $mobil->warna }}</div>
